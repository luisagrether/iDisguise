...
public class EntityTrackerEntry_v1_13_R1 extends EntityTrackerEntry {
    ...
    EntityTrackerEntry_v1_13_R1(EntityTrackerEntry original, int targetId) throws IllegalAccessException {
        super(
            original.b(),
    ...
    public static void inject(Entity entity, Player player) throws IllegalAccessException {
        ...
        if(original instanceof EntityTrackerEntry_v1_13_R1) {
            return;
        } else {
            ...
            EntityTrackerEntry_v1_13_R1 intruder = new EntityTrackerEntry_v1_13_R1(original, player.getEntityId());
    ...
    public static void toggleIntercept(Entity entity, Player player, boolean intercept) {
        ...
        if(!(entry instanceof EntityTrackerEntry_v1_13_R1)) {
            throw new IllegalStateException();
        } else {
            EntityTrackerEntry_v1_13_R1 intruder = (EntityTrackerEntry_v1_13_R1)entry;
