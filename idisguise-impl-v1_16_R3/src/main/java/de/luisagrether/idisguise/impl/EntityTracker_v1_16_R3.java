...
public class EntityTracker_v1_16_R3 extends EntityTracker {
    ...
    EntityTracker_v1_16_R3(PlayerChunkMap chunkMap, EntityTracker original, int targetId) throws IllegalAccessException {
        chunkMap.super(
            (net.minecraft.server.v1_16_R3.Entity)EntityTracker_tracker.get(original),
    ...
    public static void inject(Entity entity, Player player) throws IllegalAccessException {
        ...
        if(original instanceof EntityTracker_v1_16_R3) {
            return;
        } else {
            chunkMap.trackedEntities.remove(entity.getEntityId());
            EntityTracker_v1_16_R3 intruder = new EntityTracker_v1_16_R3(chunkMap, original, player.getEntityId());
    ...
    public static void toggleIntercept(Entity entity, Player player, boolean intercept) {
        ...
        if(!(tracker instanceof EntityTracker_v1_16_R3)) {
            throw new IllegalStateException();
        } else {
            EntityTracker_v1_16_R3 intruder = (EntityTracker_v1_16_R3)tracker;
