...
public class Config {
    ...
    public List<String> DISGUISE_TYPE_BLACKLIST = Arrays.asList(
		"DRAGON_FIREBALL", "EGG", "ENDER_CRYSTAL", "ENDER_DRAGON", "ENDER_PEARL", "ENDER_SIGNAL", "EVOKER_FANGS", "EXPERIENCE_ORB", "FALLING_BLOCK",
		"FIREBALL", "FIREWORK", "FISHING_HOOK", "GLOW_ITEM_FRAME", "ITEM_FRAME", "LEASH_HITCH", "LIGHTNING", "LLAMA_SPIT", "PAINTING", "PRIMED_TNT",
		"SHULKER_BULLET", "SMALL_FIREBALL", "SNOWBALL", "SPLASH_POTION", "THROWN_EXP_BOTTLE", "UNKNOWN", "WITHER_SKULL"
	);
	public List<String> STATEMENT_WHITELIST = Arrays.asList(
		...
		"setCarryingChest", "setFoxType", "setSleeping", "setLeftHorn", "setRightHorn", "setScreaming", "setColor", "setStyle", "setEating", "setHiddenGene", "setMainGene", "setOnBack", "setRolling","setSneezing",
		"setRabbitType", "setState", "setSaddle", "setShivering", "setAngry", "setSkeletonType", "setBoatType", "setAwake", "setProfession", "setVillagerType", "setSize", "setPuffState", "setVillager"
	);
