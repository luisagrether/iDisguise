...
public class EntityTrackerEntry_v1_8_R1 extends EntityTrackerEntry {
    ...
    EntityTrackerEntry_v1_8_R1(EntityTrackerEntry original, int targetId) throws IllegalAccessException {
        super(
            original.tracker,
            original.b,
            original.c,
    ...
    public static void inject(Entity entity, Player player) throws IllegalAccessException {
        ...
        EntityTrackerEntry original = (EntityTrackerEntry)tracker.trackedEntities.get(entity.getEntityId());
        if(original instanceof EntityTrackerEntry_v1_8_R1) {
            return;
        } else {
            ...
            EntityTrackerEntry_v1_8_R1 intruder = new EntityTrackerEntry_v1_8_R1(original, player.getEntityId());
            tracker.trackedEntities.a(entity.getEntityId(), intruder);
            entrySet.add(intruder);
            for(Object observer : new ArrayList<>(original.trackedPlayers)) {
                original.clear((EntityPlayer)observer);
                intruder.updatePlayer((EntityPlayer)observer);
            }
        }
    }
    ...
    public static void toggleIntercept(Entity entity, Player player, boolean intercept) {
        ...
        if(!(entry instanceof EntityTrackerEntry_v1_8_R1)) {
            throw new IllegalStateException();
        } else {
            EntityTrackerEntry_v1_8_R1 intruder = (EntityTrackerEntry_v1_8_R1)entry;
