...
public class EntityTracker_v1_14_R1 extends EntityTracker {
    ...
    EntityTracker_v1_14_R1(PlayerChunkMap chunkMap, EntityTracker original, int targetId) throws IllegalAccessException {
        chunkMap.super(
            (net.minecraft.server.v1_14_R1.Entity)EntityTracker_tracker.get(original),
    ...
    public static void inject(Entity entity, Player player) throws IllegalAccessException {
        ...
        if(original instanceof EntityTracker_v1_14_R1) {
            return;
        } else {
            chunkMap.trackedEntities.remove(entity.getEntityId());
            EntityTracker_v1_14_R1 intruder = new EntityTracker_v1_14_R1(chunkMap, original, player.getEntityId());
    ...
    public static void toggleIntercept(Entity entity, Player player, boolean intercept) {
        ...
        if(!(tracker instanceof EntityTracker_v1_14_R1)) {
            throw new IllegalStateException();
        } else {
            EntityTracker_v1_14_R1 intruder = (EntityTracker_v1_14_R1)tracker;
